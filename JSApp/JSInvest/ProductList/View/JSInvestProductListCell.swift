...
class JSInvestProductListCell: UITableViewCell {
...
//        //线条
//        let lineLabel = setupLabel(0, y: bgView.height + bgView.y, width: SCREEN_WIDTH, height: 1, font: 0, textColor: UIColor.whiteColor(), textAlignment: .Center, text: "", ishaveBorder: false,view:self.contentView)
//        lineLabel.backgroundColor = DEFAULT_GRAYCOLOR
        
        //基础利率
//        rateTitleLabel = setupLabel(0, y: bgView.height + bgView.y + 14 * SCREEN_SCALE_W, width: SCREEN_WIDTH / 3, height: 12 * SCREEN_SCALE_W, font: 12 * SCREEN_SCALE_W, textColor: Default_All9_Color, textAlignment: .Center, text: "历史年化收益率", ishaveBorder: false, view: self.contentView)
        
        //基础利率
        rateLabel = setupLabel(20 , y: bgView.height + bgView.y + 14 * SCREEN_SCALE_W, width: 75 * SCREEN_SCALE_W, height: 40 * SCREEN_SCALE_W, font: 28 * SCREEN_SCALE_W, textColor: DEFAULT_GREENCOLOR, textAlignment: .center, text: "", ishaveBorder: false,view: self.contentView)
...
//        deadlineTitleLabel = setupLabel(SCREEN_WIDTH / 3 + 10 * SCREEN_SCALE_W, y: rateTitleLabel.y, width: SCREEN_WIDTH / 3, height: 12 * SCREEN_SCALE_W, font: 12 * SCREEN_SCALE_W, textColor: Default_All9_Color, textAlignment: .Center, text: "期限", ishaveBorder: false, view: self.contentView)
        ...
        //圆圈
        pertProgressView = KDCircularProgress(frame: CGRect(x: SCREEN_WIDTH - (70 * SCREEN_SCALE_W), y: 45 * SCREEN_SCALE_W, width: 60 * SCREEN_SCALE_W, height: 60 * SCREEN_SCALE_W))
...
//        self.pertLabel.hidden = true
        ...
        //线条
//        let lineLabel2 = setupLabel(rateLabel.x, y: rateLabel.y + rateLabel.height + 14 * SCREEN_SCALE_W, width: SCREEN_WIDTH - 2 * rateLabel.x, height: 1 * SCREEN_SCALE_W, font: 0, textColor: UIColor.whiteColor(), textAlignment: .Center, text: "", ishaveBorder: false,view:self.contentView)
