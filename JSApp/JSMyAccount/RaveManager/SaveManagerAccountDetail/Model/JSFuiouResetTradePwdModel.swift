//
//  JSFuiouResetTradePwdModel.swift
//  JSApp
//
...
class JSFuiouResetTradePwdModel: JSBaseModel {
    var map: JSFuiouResetTradePwdMapModel?
...
class JSFuiouResetTradePwdMapModel: NSObject {
    var fuiouUrl: String = ""
