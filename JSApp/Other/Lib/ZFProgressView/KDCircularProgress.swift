...
open class KDCircularProgress: UIView {
    ...
    open func pauseAnimation() {
        ...
        //guard let presentationLayer = progressLayer.presentationLayer() as! KDCircularProgress.KDCircularProgressViewLayer else { return }
//        guard let presentationLayer:KDCircularProgressViewLayer = progressLayer.presentationLayer()! else {return}
//        
...
//        angle = currentValue
        ...
        if progressLayer.presentation() != nil {
            
            let presentationLayer: KDCircularProgressViewLayer = progressLayer.presentation()!
    ...
    fileprivate class KDCircularProgressViewLayer: CALayer {
        ...
        override func draw(in ctx: CGContext) {
            ...
            ctx.addArc(center: CGPoint(x: CGFloat(size.width/2.0), y: CGFloat(size.height/2.0)), radius: arcRadius, startAngle: 0, endAngle: CGFloat(M_PI * 2), clockwise: false)
...
//            CGContextAddArc(ctx, CGFloat(size.width/2.0), CGFloat(size.height/2.0), arcRadius, 0, CGFloat(M_PI * 2), 0)
            ...
            imageCtx?.addArc(center: CGPoint(x: CGFloat(size.width/2.0), y: CGFloat(size.height/2.0)), radius: arcRadius, startAngle: fromAngle, endAngle: toAngle, clockwise: clockwise)
//            CGContextAddArc(imageCtx!, CGFloat(size.width/2.0),CGFloat(size.height/2.0), arcRadius, fromAngle, toAngle, clockwise == true ? 1 : 0)
            ...
            if colorsArray.count > 1 {
                ...
                for color in rgbColorsArray {
                    ...
                    componentsArray.append((colorComponents?[0])!)
                    componentsArray.append((colorComponents?[1])!)
                    componentsArray.append((colorComponents?[2])!)
                    componentsArray.append(1.0)
