...
open class activityIndicator: UIView {
    ...
    fileprivate func setStrokeSuccessShapePath() {
        ...
        path.move(to: CGPoint(x: point.x, y: point.y), transform: CGAffineTransform())
        path.addLine(to: CGPoint(x: b - xOffset, y: b + yOffset), transform: CGAffineTransform())
        path.addLine(to: CGPoint(x: 2 * b - xOffset + yOffset - ySpace, y: ySpace), transform: CGAffineTransform())
    ...
    fileprivate func setStrokeFailureShapePath() {
        ...
        path.move(to: CGPoint(x: point.x, y: point.y), transform: CGAffineTransform())
        path.addLine(to: CGPoint(x: 2 * b - space, y: 2 * b - space), transform: CGAffineTransform())
        path.move(to: CGPoint(x: 2 * b - space, y: space), transform: CGAffineTransform())
        path.addLine(to:CGPoint(x: space, y: 2 * b - space), transform: CGAffineTransform())
